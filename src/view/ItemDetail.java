...
//	String iconImgUrl = "c:\\icon\\";
	...
	public ItemDetail(ItemBbs itemDto, List<Category> categoryList) {
		...
		if (this.m_itemDto.getImgurl1().equals("") || this.m_itemDto.getImgurl1() == null) {
			this.m_itemDto.setImgurl1(nullimgURL);
		}
		if (this.m_itemDto.getImgurl2().equals("")|| this.m_itemDto.getImgurl1() == null) {
			this.m_itemDto.setImgurl1(nullimgURL);
		}
		if (this.m_itemDto.getImgurl3().equals("")|| this.m_itemDto.getImgurl1() == null) {
			this.m_itemDto.setImgurl1(nullimgURL);
		}
		if (this.m_itemDto.getImgurl4().equals("")|| this.m_itemDto.getImgurl1() == null) {
			this.m_itemDto.setImgurl1(nullimgURL);
		}
